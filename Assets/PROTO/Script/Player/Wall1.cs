...
public class Wall1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //左に移動  
        if ((Left > 0 || Input.GetKey("left")) && PlayerMove.Wall_Move1 == true && PlayerMove.PlayerDirection == 1 && PlayerMove.WallNo1 == true)
        {
        ...
        //右に移動
        if ((Right > 0 || Input.GetKey("right")) && PlayerMove.Wall_Move1 == true && PlayerMove.PlayerDirection == -1 && PlayerMove.WallNo1 == true)
        {
