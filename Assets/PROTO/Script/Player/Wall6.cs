...
public class Wall6 : MonoBehaviour
{
    ...
    public static bool wallcollision6 = false;
    // Start is called before the first frame update
    void Start()
    {
        wallcollision6 = false;
    }
    ...
    void Update()
    {
        ...
        //左に移動  
        if ((Left > 0 || Input.GetKey("left")) && PlayerMove.Wall_Move6 == true && PlayerMove.PlayerDirection == 1 && PlayerMove.WallNo6 == true && wallcollision6 == false)
        {
        ...
        //右に移動
        if ((Right > 0 || Input.GetKey("right")) && PlayerMove.Wall_Move6 == true && PlayerMove.PlayerDirection == -1 && PlayerMove.WallNo6 == true && wallcollision6 == false)
        {
