...
public class Wall : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //左に移動  
        if ((Left > 0 || Input.GetKey("left")) && PlayerMove.Wall_Move0 == true && PlayerMove.PlayerDirection == 1 && PlayerMove.WallNo0 == true)
        {
        ...
        //右に移動
        if ((Right > 0 || Input.GetKey("right")) && PlayerMove.Wall_Move0 == true && PlayerMove.PlayerDirection == -1 && PlayerMove.WallNo0 == true)
        {
