...
public class Wall : MonoBehaviour
{
    ...
    public static bool wallcollision0 = false;
    // Start is called before the first frame update
    void Start()
    {
        wallcollision0 = false;
    }
    ...
    void Update()
    {
        ...
        //左に移動  
        if ((Left > 0 || Input.GetKey("left")) && PlayerMove.Wall_Move0 == true && PlayerMove.PlayerDirection == 1 && PlayerMove.WallNo0 == true && wallcollision0 == false)
        {
        ...
        //右に移動
        if ((Right > 0 || Input.GetKey("right")) && PlayerMove.Wall_Move0 == true && PlayerMove.PlayerDirection == -1 && PlayerMove.WallNo0 == true && wallcollision0 == false)
        {
