...
public class Wall5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //左に移動  
        if ((Left > 0 || Input.GetKey("left")) && PlayerMove.Wall_Move5 == true && PlayerMove.PlayerDirection == 1 && PlayerMove.WallNo5 == true && wallcollision5 == false)
        {
        ...
        //右に移動
        if ((Right > 0 || Input.GetKey("right")) && PlayerMove.Wall_Move5 == true && PlayerMove.PlayerDirection == -1 && PlayerMove.WallNo5 == true && wallcollision5 == false)
        {
