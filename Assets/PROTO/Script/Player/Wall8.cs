...
public class Wall8 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //左に移動  
        if ((Left > 0 || Input.GetKey("left")) && PlayerMove.Wall_Move8 == true && PlayerMove.PlayerDirection == 1 && PlayerMove.WallNo8 == true && wallcollision8 == false)
        {
        ...
        //右に移動
        if ((Right > 0 || Input.GetKey("right")) && PlayerMove.Wall_Move8 == true && PlayerMove.PlayerDirection == -1 && PlayerMove.WallNo8 == true && wallcollision8 == false)
        {
