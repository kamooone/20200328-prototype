...
public class Wall7 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //左に移動  
        if ((Left > 0 || Input.GetKey("left")) && PlayerMove.Wall_Move7 == true && PlayerMove.PlayerDirection == 1 && PlayerMove.WallNo7 == true && wallcollision7 == false)
        {
        ...
        //右に移動
        if ((Right > 0 || Input.GetKey("right")) && PlayerMove.Wall_Move7 == true && PlayerMove.PlayerDirection == -1 && PlayerMove.WallNo7 == true && wallcollision7 == false)
        {
